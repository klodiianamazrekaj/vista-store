            ...
            <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
                ...
                <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
                    <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full'>
                        {
                            teDhenatProduktit.image.map((item, index) => (
                ...
                <div className='flex-1'>
                    <h1 className='font-medium text-2xl mt-2'>{teDhenatProduktit.name}</h1>
                    ...
                    <p className='mt-5 text-3xl font-medium'>{valuta}{teDhenatProduktit.price}</p>
                    <p className='mt-5 text-gray-500 md:w-4/5'>{teDhenatProduktit.description}</p>

                    <div className='flex flex-col gap-4 my-8'>
                        <p>Zgjidhni madhësinë</p>
                        <div className='flex gap-2'>
                            {teDhenatProduktit.sizes.map((item, index) => (
